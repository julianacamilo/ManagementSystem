...
>
      <div className="flex flex-col  md:flex-row md:space-x-4 mx-auto">
        <div className="md:w-1/2 bg-white p-6 rounded-md shadow-md mt-4">
          <h1 className="text-2xl text-purple-600 font-semibold mb-4">Adicione aqui <br /> Seu Investimento</h1>
          <p className="text-1x1 mt-20"> Receba feedback dos seus investimentos <br />  </p>
          <div className="mb-4">
          ...
          <button className="w-full bg-purple-700 text-white rounded-full py-2 hover:bg-purple-800">
